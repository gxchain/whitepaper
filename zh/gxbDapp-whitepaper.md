...
为此公信宝Dapp推出了数字资产抵押功能，抵押者可以发起一个抵押合约，按照当前市值的1/3或者1/2\(需支付略高利息\)价格抵押出其它的资产（如人民币或者比特币），抵押物会被暂时冻结，如果抵押者违约，则抵押物归投资者所有，首期支持GXS的抵押功能，今后还会添加更多其他的数字资产抵押功能，如BTC、ETH等。
