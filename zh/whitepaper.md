...
已经开发出来并上线的应用，证明了公信链在商业上的可用性，基于公信链的第一个B2B应用——公信宝去中心化交易所，已经在2017年9月24日正式商用，截止2017年10月底已完成超过700万笔数据交易。
...
公信宝将用数据交易所佣金收入的10%，回购二级市场上发行的公信股（GXS）。回购的公信股将转移至销毁账户进行销毁。我们将确保整个过程的公开透明：回购记录将在第一时间公示，届时用户也可通过公信宝区块链浏览器查询，这个过程将持续到销毁ICO+私募发行的公信股总量（共4900万股）为止。
