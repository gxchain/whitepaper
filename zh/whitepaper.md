...
数据，是未来世界最巨大的资源，未来它的规模大到无法想象，它的应用将无所不在；区块链，是未来世界最重要的基础设施，它是一个信任机器，构建了一个可信任的价值网络，这两者结合在一起

近几年来，随着互联网的高速发展和信息技术的普及应用，行业应用所产生的数据呈爆炸性增长，在快速发展的同时也带来了数据的垄断和信息孤岛，  
大数据交换背后所带来的巨大价值也应运而生。
