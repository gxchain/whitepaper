...
> 大数据时代的出现让人类进入了万物互联的时代，取得对数据进行重新处理的能力也远远超过过去，对世界的认识将会提升到一个新的高度，大数据让预判和计划都成为了可能。

近几年来，随着互联网的高速发展和信息技术的普及应用，行业应用所产生的数据呈爆炸性增长，在快速发展的同时也带来了数据的垄断和信息孤岛，大数据交换背后所带来的巨大商业机会也应运而生。

数据，是未来世界最巨大的资源，未来它的规模大到无法想象，它的应用多到无所不在；区块链，是未来世界最重要的基础设施，它是一个信任机器，构建了一个让所有参与者都可以共同维护的可信价值互联网。
