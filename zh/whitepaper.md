...
简单来说，GXC是公信宝数据交易所里的数据交易支付Token，针对有买卖数据需求的客户而发行；而GXS是在数字货币交易所可以流通交易的数字货币，它的价值主要体现在以下两方面：
1.随着公信宝合作的客户和数据源越来越多，数据交易所的交易量越来越大，公信宝就可以收到更多的佣金，团队会拿出佣金收入的10%按照当时的价格回购GXS并销毁。
2.
