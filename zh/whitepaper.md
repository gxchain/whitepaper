...
而第二个基于公信链的应用，面向大众的个人信用管理工具公信宝DAPP（去中心化app），也将在今年发布测试版。

此外，公信链也将为政务的数据信息交换提供安全可靠的解决方案，让接入区块链的政府机构数据，在各方都不缓存、修改对方数据的情况下，通过一个窗口汇集和使用数据，为广大民众提供“最多跑一次”式的优质政府服务，不但大大提升服务体验，还提升了整个社会的效率。
