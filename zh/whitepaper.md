...
近几年来，随着互联网的高速发展和信息技术的普及应用，各个行业和机构所产生的数据呈爆炸性增长，对于全社会来说，这是一个在不断膨胀的巨大宝库。但是在数据量呈几何级数增加的同时，巨头对数据的垄断和机构间信息孤岛的情况也亟待破局。“将大数据交换起来”，这背后蕴含着巨大的生产效率提升空间和商业价值。

数据，是未来世界最重要的资源，不但规模巨大，且将随着人们行为的变迁而不断流变，成为我们测量、理解一个时代商业和社会的核心要素，它也将是所有行业的标配生产要素；而区块链技术，是未来世界最重要的基础技术之一，它构建了一个让所有参与者都可以共同维护的可信价值互联网。而它作为一个传输价值的信任网络，能够让数据这项最重要的生产资料，在流通中的成本降至最低。

可以说，区块链这项未来最重要的底层技术，与数据这项未来最重要的社会资源结合在一起，天生就能释放出极大的商业价值、社会价值。公信宝的技术和商业基础，就是构建于此，并开发了一系列基于区块链和数据的公链和应用产品。

其中，最底层的就是我们的公链——公信链（GXChain）。
