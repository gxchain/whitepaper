...
这是公信宝官方工程师在公信链上开发的一款让个人使用的面对面信用验证工具，在得到他人的授权同意后，通过公信宝数据交易所查询他的个人数据，未来个人的健康病历、交通出行、教育培训、工作经历、兴趣爱好、征信记录都是个人身份档案中最重要的数据数据组成，从而完成对他的信息验证，广泛适用于招聘、相亲、租房、租车、二手交易、贷款等需要个人信用作为交易的领域；同时还有个人信息所有权管理，管理自己在公共领域的健康、消费、出行、工作等信息  
